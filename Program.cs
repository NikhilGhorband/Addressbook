    ...
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("4. Edit contact book.");
                ...
                Console.WriteLine("11. Sort entries by FirstName and LastName");
                Console.WriteLine("12. Sort entries book by City");
                Console.WriteLine("13. Sort entries by State");
                Console.WriteLine("14. Sort entries by Zipcode");
